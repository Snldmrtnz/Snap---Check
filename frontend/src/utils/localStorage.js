...
export const getSheetGenerated = (sheetId) => localStorage.getItem(`sheetGenerated_${sheetId}`) === 'true';
export const setSheetGenerated = (sheetId, generated = true) => localStorage.setItem(`sheetGenerated_${sheetId}`, generated.toString());
export const removeSheetGenerated = (sheetId) => localStorage.removeItem(`sheetGenerated_${sheetId}`); 